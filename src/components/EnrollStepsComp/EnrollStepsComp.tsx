    ...
    return (
        <div className={classes.Wrapper}>
            <div className={classes.Step}>
                ...
                <h6 style={{color: enrollStep!==3?'#1D92F8' : '#000000'}}>Выбор времени</h6>
            </div>
            <div className={classes.Line} style={{backgroundColor: enrollStep===1?'#2C3E501F':(enrollStep===2?'#1D92F8':'#000000')}}></div>
            <div className={classes.Step}>
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h6 style={{color: enrollStep===1?'rgba(44,62,80,0.56)':(enrollStep===2?'#1D92F8':'#000000')}}>Подтверждение</h6>
            </div>
            <div className={`${classes.Line} ${classes.Line2}`} style={{backgroundColor: enrollStep===3?'#000000':'#2C3E501F'}}></div>
            <div className={`${classes.Step} ${enrollStep===3?classes.Step3_Black:classes.Step3_Gray}`}>
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="40" height="40" rx="20" />
